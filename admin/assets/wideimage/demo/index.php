<?php
  ...
  **/
	...
	include '../../../galerias - Cópia/wideimage/demo/helpers/common.php';
	require_once '../../../galerias - Cópia/wideimage/lib/WideImage.php';
...
<style>
	body
	{
		...
		background-image: url("../../../galerias - Cópia/wideimage/demo/bg.gif");
	...
	<body>
		<div class="navbar">
			<strong><a href="../../../galerias - Cópia/wideimage/demo/index.php">WideImage demos</a></strong>
...
<?php
	if ($activeDemo)
	{
		include '../../../galerias - Cópia/wideimage/demo/demo_screen.php';
	}
?>
		</div>
	</body>
